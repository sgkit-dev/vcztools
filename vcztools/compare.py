...
def compare(f1, f2, *, rtol=1e-05, atol=1e-03, allow_zero_variants=False):
    return assert_vcfs_close(
        f1, f2, rtol=rtol, atol=atol, allow_zero_variants=allow_zero_variants
    )
